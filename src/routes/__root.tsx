...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Tucamax — Inteligência comercial B2B" },
      { property: "og:description", content: "Velocidade que voa alto. Encontre e enriqueça empresas brasileiras em segundos." },
